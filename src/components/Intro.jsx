...
function Intro() {
  ...
  return (
    <section className='container mt-5 p-5 w-full flex-col lg:flex' id='mcq'>
        ...
        <div key={index} className='flex justify-center items-center p-1 w-[280px] h-[470px] lg:w-[245px] lg:h-[470px] md:w-[380px] md:h-[500] xl:w-[350px] xl:h-[500px] bg-primary rounded-2xl rotate-12 hover:rotate-0 duration-300'>
            ...
            <div className='flex w-full lg:px-0 items-center justify-center'>
                            <img src={card.image} className='w-[500px] lg:w-[260px] rounded-t-[8px] rounded-br-[10px] rounded-bl-[220px]'/>
                        </div>
        ...
        <div className='flex justify-center items-center md:my-5 mt-12 mb-5'>
            <button className='px-10 py-2 text-bluebg bg-primary flex justify-center items-center gap-2 rounded-full text-xl hover:bg-secondary'><Link to="/qsuser">Start Now</Link> <GiArrowScope className='hover:animate-bounce' size={40}/></button>
        </div>
    </section>
  )
}
