  ...
  return (
    <div className='flex flex-col gap-40'>
      ...
      <div className='w-full flex flex-row'>
        ...
        <div className='w-2/5 flex flex-col gap-48 ms-12'>
          ...
          <div className='flex flex-col gap-8'>
            ...
            <p className='w-3/5 tracking-wide text-5xl leading-[4rem] font-bold p-4 capitalize'>welcome to quizsnap {mcqid} skill test</p>
        ...
        <div className='w-1/2 flex flex-col gap-40'>
          <p className='w-full tracking-wide leading-8 text-xl'>
          ...
          <div className='flex flex-col gap-8'>
            ...
            <p className='text-4xl text-textlg tracking-wider'>Instructions</p>

            <ul className='list-disc flex flex-col text-[16px] gap-4 ms-8 text-secgray'>
              {
                instructions.map((points, index) => {
                  return (
                    <li key={index} className='duration-200 hover:scale-105'>{points.point}</li>
                  )
                })
              }
            </ul>
            <p className='text-[16px] text-secgray'>These instructions will ensure clarity and a smooth user experience during the quiz, for more details <Link to='/detailinfo' className='underline text-secondary hover:text-primary italic'>click here</Link>.</p>
          </div>
          <div className='w-full flex items-center justify-center'>
            <button className='px-10 py-2 text-bluebg bg-primary flex justify-center items-center gap-2 rounded-full text-xl hover:bg-secondary tracking-widest'><Link to="/quiz/testpage" target='_blank'>Start</Link> <GiArrowScope className='' size={40} /></button>
          </div>
        </div>
