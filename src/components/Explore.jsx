                        ...
                        allCategory.map((category, i) => {
                            return (
                                <Link to={`/quiz/explore/${category.category}`}>
                                    <div className='w-72 flex flex-col p-4 justify-center items-center gap-4 m-4 2xl:m-8 shadow-2xl border-t border-lggray rounded-t-lg hover:-translate-y-2 duration-300 group'>
