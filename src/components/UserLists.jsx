...

        {
          filterDatas.map((data, index) => {
            return (
              ...
              <div key={index} className={'bg-bgimg2 bg-cover border-2 border-secbr  lg:w-[47%] w-11/12 h-60 p-4 flex flex-col md:flex-row justify-evenly items-center rounded-md duration-150 hover:scale-[1.05]'}>
                ...
                <div className='flex flex-row md:flex-col justify-center items-center gap-2'>
                  ...
                  <div className='flex flex-row items-center justify-center gap-2 md:gap-6'>
                    ...
                    <button className={"p-2 flex justify-center items-center gap-2 bg-outlg text-primary duration-300 hover:bg-primary hover:text-bluebg rounded-full"}
                      onClick={""}><AiTwotoneEdit /></button>

                    <button className={"p-2 flex justify-center items-center gap-2 bg-outlg duration-300 text-redbg hover:bg-redbg hover:text-bluebg rounded-full"}
                      onClick={""}><MdOutlineDeleteOutline /></button>
