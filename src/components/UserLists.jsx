...
function UserLists() {
  ...
  return (
    ...
    <div className='w-full flex lg:flex-row flex-col lg:flex-wrap gap-8 xl:justify-evenly md:items-baseline items-center relative mb-8'>
                ...
                <div className='flex flex-row md:flex-col justify-center items-center gap-2'>
                  ...
                  <div className='flex flex-row items-center justify-center gap-2 md:gap-6'>
                    ...
                    <button className={"p-2 flex justify-center items-center gap-2 bg-outlg duration-300 text-redbg hover:bg-redbg hover:text-bluebg rounded-full"}
                      onClick={bgBlur ? null : () => showDeletePopup(data.id)}><MdOutlineDeleteOutline /></button>
      ...
      {deletePopup && (
        <div className="popup-card absolute w-[40rem] h-[20rem] flex flex-col justify-around items-center">
